...
namespace ApexSharpBaseTest.CodeFormatter
{
    ...
    public class FormatterTests
    {
        ...
        {
            var formatted = FormatApexCode.GetFormattedApexCode(source);
        ...
        [Test]
        public void FormaterTestDemoClass() =>
            ValidateLineByLine(FormaterTestData.DemoInput, FormaterTestData.DemoOutPut);
