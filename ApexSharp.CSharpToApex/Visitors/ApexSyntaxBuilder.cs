...
namespace ApexSharp.CSharpToApex.Visitors
{
    public class ApexSyntaxBuilder : CSharpSyntaxWalker
    {
        ...
        internal static bool IsAutoGenerated(MemberDeclarationSyntax member)
        {
        ...
        internal static bool IsExceptionClassWithApexParserGeneratedConstructor(ClassDeclarationSyntax node)
        {
        ...
        private static void AddAnnotationOrModifier(IAnnotatedSyntax member, object converted)
        {
        ...
        private static object ConvertClassAnnotation(ApexAnnotationSyntax node)
        {
            // annotations
        ...
        private static object ConvertMethodAnnotation(ApexAnnotationSyntax node)
        {
            // annotations
        ...
        private static object ConvertFieldAnnotation(ApexAnnotationSyntax node)
        {
            // modifiers
        ...
        private static object ConvertParameterAnnotation(ApexAnnotationSyntax node)
        {
            // modifiers
        ...
        internal List<string> CommentOutNoApexCode(string code)
        {
            ...
            static int CalcIndent(string line) =>
        ...
        private static ApexTypeSyntax ConvertType(TypeSyntax type)
        {
            if (type != null)
            {
        ...
        private static ApexExpressionSyntax ConvertExpression(ExpressionSyntax expression)
        {
            if (expression == null)
            {
                return null;
        ...
        {
            static bool Equals(ExpressionSyntax left, string right) =>
        ...
        public override void VisitCasePatternSwitchLabel(CasePatternSwitchLabelSyntax node)
        {
            ...
            if (pattern == null || type == null || pattern?.Designation is not SingleVariableDesignationSyntax designation)
            {
