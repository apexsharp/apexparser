...
namespace ApexSharpDemo.ApexApiAnalyzer
{
    public class AnylyzResult
    {
    ...
    public class Analyzer
    {
        ...
        public List<AnylyzResult> AnylyzDir(string path)
        {
            List<AnylyzResult> results = new List<AnylyzResult>
            {
                new AnylyzResult() {ClassName = "System", MethodName = "debug"}
            };
