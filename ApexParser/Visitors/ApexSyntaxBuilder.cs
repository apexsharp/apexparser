...
namespace ApexParser.Visitors
{
    public class ApexSyntaxBuilder : CSharpSyntaxWalker
    {
        ...
        public override void VisitClassDeclaration(ClassDeclarationSyntax node)
        {
            ...
            var members = node.Members.EmptyIfNull();

            // handle special case: an exception class with a single ApexParser-generated constructor
            if (IsExceptionClassWithApexParserGeneratedConstructor(node))
            {
                // ignore the constructor generated by ApexParser
                members = Enumerable.Empty<MemberDeclarationSyntax>();
            }
