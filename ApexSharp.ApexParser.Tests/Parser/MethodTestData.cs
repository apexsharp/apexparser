...
namespace ApexSharp.ApexParser.Tests.Parser
{
    ...
    public class MethodTestData
    {
        ...
        public void MethodSigTestOne()
        {
            ...
            Assert.AreEqual(1, block.InnerComments.Count);
            Assert.AreEqual(" Comment ", block.InnerComments[0]);
        }
        ...
        public void MethodWithSomeDummyBody()
        {
            ...
            Assert.AreEqual("new List<String>()", (block.Statements[1] as ReturnStatementSyntax).Expression.ExpressionString);
        }
    }
}
