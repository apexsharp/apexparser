    ...
    public class ApexResourceTests
    {
        ...
        public void ClassOneIsParsed()
        {
            ...
            void ParseAndValidate(string text)
            {
                ...
                Assert.AreEqual("new ClassTwo()", varDecl.Variables[0].Expression.ExpressionString);
        ...
        public void Demo2IsParsed()
        {
            ...
            Assert.AreEqual("x == 5", ifstmt.Expression.ExpressionString);
            ...
            Assert.AreEqual("x == 8", innerIf.Expression.ExpressionString);
        ...
        public void ForIfWhileLoopsAreParsed()
        {
            ...
            Assert.AreEqual("0", forStmt.Declaration.Variables[0].Expression.ExpressionString);
            Assert.AreEqual("j", forStmt.Declaration.Variables[1].Identifier);
            Assert.AreEqual("0", forStmt.Declaration.Variables[1].Expression.ExpressionString);
            Assert.AreEqual("i < 10", forStmt.Condition.ExpressionString);
            Assert.NotNull(forStmt.Incrementors);
            Assert.AreEqual(1, forStmt.Incrementors.Count);
            Assert.AreEqual("i++", forStmt.Incrementors[0].ExpressionString);
            ...
            Assert.AreEqual("myInts", forEachStmt.Expression.ExpressionString);
        ...
        public void PropertyAndFieldIsParsed()
        {
            ...
            Assert.AreEqual("new List<Datetime>()", fd.Fields[0].Expression.ExpressionString);
            ...
            Assert.AreEqual("new Datetime[5]", fd.Fields[0].Expression.ExpressionString);
            ...
            Assert.AreEqual("'jay'", fd.Fields[0].Expression.ExpressionString);
        ...
        public void ClassUnitTestRunAsIsParsed()
        {
            ...
            Assert.AreEqual("newUser", runAs.Expression.ExpressionString);
        ...
        public void ForIfWhile3IsParsed()
        {
            ...
            Assert.AreEqual("[SELECT Id, Name FROM Contact]", forEach.Expression.ExpressionString);
